...
public class Robot extends IterativeRobot {
	...
	public void teleopPeriodic() {
		...
		/* Tank Drive Controls
		leftFront.set(-driver.getRawAxis(1));
		leftMid.set(-driver.getRawAxis(1));
		leftBack.set(-driver.getRawAxis(1));

		rightFront.set(-driver.getRawAxis(3));
		rightMid.set(driver.getRawAxis(3));
		rightBack.set(driver.getRawAxis(3));
		 */
		...
		//If the button is pressed or the cam sensor detects white, the catapult fires, but if it detects black, it stops.
